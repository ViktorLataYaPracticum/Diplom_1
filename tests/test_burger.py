...
def test_get_price_parametrized(bun_price, ingredients, expected):
    burger = Burger()
...
def test_get_receipt_full_match():
    burger = Burger()
...
def test_get_receipt_lines_count():
    burger = Burger()
...
def test_get_receipt_ingredients_order():
    burger = Burger()
...
def test_get_receipt_no_extra_lines():
    burger = Burger()
...
def test_get_receipt_ingredient_format():
    burger = Burger()
